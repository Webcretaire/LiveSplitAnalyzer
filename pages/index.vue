  ...
  <div class="text-center" id="index-wrapper" :style="indexWrapperStyle">
    ...
    <footer>
      ...
      <a href="https://github.com/Webcretaire/LiveSplitAnalyzer/graphs/contributors" class="text-white font-weight-bold"
         target="_blank">
        awesome contributors</a>. Its <a href="https://github.com/Webcretaire/LiveSplitAnalyzer" class="text-white font-weight-bold" target="_blank">source code</a> is available on GitHub.
    </footer>
